export const maverickPoolInformationAbi = [{
    ...
    "inputs": [{"internalType": "uint256", "name": "prod1", "type": "uint256"}, {
        ...
        "name": "denominator",
        "type": "uint256"
    }], "name": "PRBMath__MulDivOverflow", "type": "error"
}, {
    "inputs": [{"internalType": "contract IPool", "name": "pool", "type": "address"}],
    "name": "activeTickLiquidity",
    "outputs": [{"internalType": "uint256", "name": "sqrtPrice", "type": "uint256"}, {
        "internalType": "uint256",
        "name": "liquidity",
        "type": "uint256"
    ...
    "inputs": [{"internalType": "contract IPool", "name": "pool", "type": "address"}, {
        ...
        "name": "startBinIndex",
        "type": "uint128"
    }, {"internalType": "uint128", "name": "endBinIndex", "type": "uint128"}],
    "name": "getActiveBins",
    "outputs": [{
        "components": [{"internalType": "uint128", "name": "id", "type": "uint128"}, {
            "internalType": "uint8",
            "name": "kind",
            "type": "uint8"
            ...
            "name": "reserveA",
            "type": "uint128"
        }, {"internalType": "uint128", "name": "reserveB", "type": "uint128"}, {
            "internalType": "uint128",
            "name": "mergeId",
            "type": "uint128"
        }], "internalType": "struct IPoolInformation.BinInfo[]", "name": "bins", "type": "tuple[]"
    }],
    "stateMutability": "view",
    "type": "function"
}, {
    ...
    "outputs": [{
        "components": [{"internalType": "uint8", "name": "kind", "type": "uint8"}, {
            "internalType": "int32",
            "name": "pos",
            "type": "int32"
        ...
        "name": "addParams",
        "type": "tuple[]"
    }, {"internalType": "uint256", "name": "binLpTokenAmount0", "type": "uint256"}],
    "stateMutability": "view",
    "type": "function"
}, {
    "inputs": [{"internalType": "contract IPool", "name": "pool", "type": "address"}, {
    ...
    "name": "getBinDepth",
    "outputs": [{"internalType": "uint256", "name": "depth", "type": "uint256"}],
    "stateMutability": "view",
    "type": "function"
}, {
    "inputs": [{"internalType": "contract IPool", "name": "pool", "type": "address"}, {
    ...
    "outputs": [{
        "components": [{
            ...
            "type": "uint128"
        }, {"internalType": "uint128", "name": "mergeId", "type": "uint128"}, {
            "internalType": "uint128",
            "name": "totalSupply",
            "type": "uint128"
            ...
            "name": "lowerTick",
            "type": "int32"
        }], "internalType": "struct IPool.BinState[]", "name": "bins", "type": "tuple[]"
    }],
    "stateMutability": "view",
    "type": "function"
}, {
